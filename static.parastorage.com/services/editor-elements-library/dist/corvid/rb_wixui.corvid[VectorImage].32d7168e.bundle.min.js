    ...
    return function() {
        var e, t = {
                ...
                5781: function(e, t, r) {
                    ...
                    const n = r(2712).__importDefault(r(9025)),
                        o = r(4321);
                    ...
                    t.getColorFromCssStyle = e => {
                        const {
                            ...
                            blue: o,
                            alpha: a
                        } = e, l = new n.default(`#${[t,r,o].map((e=>{const t=e.toString(16);return 1===t.length?`0${t}`:t})).join("")}`);
                ...
                5412: function(e, t, r) {
                    ...
                    const i = n.__importDefault(r(9025)),
                        u = r(3554),
                        s = /(viewBox=")([^"]*)(")/i,
                    ...
                    function m(e) {
                        return `url("data:image/svg+xml,${e.replace(/"/g,"'").replace(/>\s+</g,"><").replace(/\s{2,}/g," ").replace(b,encodeURIComponent)}")`
                    }
                    ...
                    function _(e, t) {
                        const r = t ? 'role="img"' : function(e = !1) {
                            const t = {
                                role: "presentation",
                                "aria-hidden": "true"
                            };
                        ...
                        let n = e.replace(p, `$1 ${r}$2`);
                        var o;
                        return "string" == typeof t && (n = n.replace(p, `$1 aria-label="${o=t,o.replace(/&/g,"&amp;").replace(/>/g,"&gt;").replace(/</g,"&lt;").replace(/"/g,"&quot;")}"$2`)), n
                    }
                    ...
                    function A(e, t, r = {}) {
                        ...
                        if (e) {
                            ...
                            let d = null === (n = e.match(p)) || void 0 === n ? void 0 : n[0];
                            if (!d) return e;
                            e = c.test(d) ? e.replace(d, d.replace(c, `$1${h}$3`)) : e.replace(/<svg/, `<svg preserveAspectRatio="${h}"`), s.test(d) || (o === v.UGC && a && (e = e.replace(/<svg/, `<svg viewBox="${a}"`)), o !== v.UGC && l && (e = e.replace(/<svg/, `<svg viewBox="${l}"`))), o !== v.UGC && !i && l && (d = e.match(p)[0], e = e.replace(d, d.replace(s, `$1${l}$3`)))
                        }
                        return e
                    }
                    const x = {
                    ...
                    t.yb = (e, {
                        ...
                        const h = (p = f || {}, Object.keys(p).reduce(((e, t) => {
                            const r = p[t];
                        ...
                        const d = function(e) {
                            ...
                            const t = h && h.color1 || "#242323",
                                r = (0, o.getFromColorMap)(t, c);
                            return n.svgType === v.TINT ? k(e, r) : e
                        }(_(e, t)));
                        return function(e) {
                            if (n.svgType === v.COLOR && Object.keys(h).length > 0) {
                                return M(e, Object.entries(h).map((([e, t]) => {
                                    const n = (0, o.getFromColorMap)(t, c),
                                        a = e.replace("color", "");
                            ...
                            return function({
                                ...
                                if (a && a.color) {
                                    const i = `${e}-shadow`;
                                    return `\n          <svg height="100%" width="100%">\n              <defs>${$(i,a,r,(0,o.getFromColorMap)(a.color,n),!l)}</defs>\n              <g filter="url(#${i})">\n                  ${w(t)}\n              </g>\n          </svg>\n      `
                                }
                                return t
                            }({
                                compId: r,
                        ...
                        p = {
                            ...
                            shadow: function(e) {
                                var t = e.value,
                                    ...
                                    a = n.__rest(t, ["blurRadius", "mergeGraphic"]);
                ...
                5609: function(e, t) {
                    ...
                    Object.defineProperty(t, "__esModule", {
                        value: !0
                    }), t.SVG_TYPES = t.getAll = t.elementsRegexes = t.attributesRegexes = t.parseSvgString = void 0;
                    const r = {
                        SHAPE: "shape",
                        TINT: "tint",
                        COLOR: "color",
                    ...
                    const a = e => {
                        ...
                        l = (e, t, r) => {
                            const n = t.exec(e);
                            return n ? [n[1], ...l(e, t, r)] : r ? [r] : []
                        };
                    t.getAll = l;
                    const i = (e, t) => {
                        if (e === r.UGC) {
                            const [e] = l(t, n.width), [r] = l(t, n.height);
                            if (e && r) return `0 0 ${e} ${r}`
                        }
                        return ""
                    };
                    t.parseSvgString = e => {
                        const [t] = l(e, o.svg), u = l(e, o.path), [s] = l(t, n["data-type"], r.SHAPE), [c] = l(t, n.viewBox).concat([i(s, t)]), [f] = l(t, n["data-bbox"]) || "";
                        return {
                            content: e,
                            info: Object.assign(Object.assign({}, u.reduce(((e, t) => {
                                const [r] = l(t, n["data-color"]), [o] = l(t, n.fill);
                ...
                6719: function(e, t, r) {
                    ...
                    const a = "<svg data-failed />",
                        ...
                        h = (e, t) => {
                            if (o.pd(e)) return ((e, t) => {
                                const [r] = e.replace(s, "").split("/"), n = (e => {
                        ...
                        d = async (e, t, r) => {
                            ...
                            return g(u) || n === i || (u = await p(u, r)), u
                        },
                        g = e => e === a;
                    var y = r(2449),
                        v = r(7930),
                    ...
                    const A = (e, t) => {
                        ...
                        x = (0, v.S)((e => {
                            ...
                            return {
                                get src() {
                                    return s.userSrc || (e = n.svgId, t = n.altText, `wix:vector://v1/${e}/${t?encodeURIComponent(t):""}`);
                                    var e, t
                                },
                                set src(e) {
                                    c({
                                    ...
                                    const {
                                        type: o
                                    } = h(e, n.mediaSvgUrl), a = [l, u].includes(o);
                                    r((e => e ? {
                                        "--stroke-width": "unset",
                                        "--stroke": "unset"
                                    } : {})(a)), t(d(e, n.mediaSvgUrl, i.sanitizeSVG).then((e => ((e, t, r, n) => e === l ? {
                                        svgContent: t,
                                        shouldScaleStroke: r
                                    } : {
                                        svgContent: g(t) ? t : A(t, n),
                                        shouldScaleStroke: r
                                    })(o, e, a, n))))
                                },
                                toJSON() {
                ...
                9025: function(e, t, r) {
                    ...
                    function s(e, t) {
                        ...
                        if (null == e) this.model = "rgb", this.color = [0, 0, 0], this.valpha = 1;
                            ...
                            var g = d.sort().join("");
                            if (!(g in i)) throw new Error("Unable to parse color from object: " + JSON.stringify(e));
                            this.model = i[g];
                    ...
                    s.prototype = {
                        ...
                        if (-1 === l.indexOf(e)) {
                            ...
                            s.prototype[e] = function() {
                                ...
                                return new s((r = o[this.model][e].raw(this.color), Array.isArray(r) ? r : [r]).concat(n), e)
                            }, s[e] = function(r) {
                                return "number" == typeof r && (r = h(a.call(arguments), t)), new s(r, e)
                            }
                        }
                    })), e.exports = s
                },
                ...
                2712: function(e, t, r) {
                    ...
                    function s(e, t, r, n, o, a) {
                        ...
                        for (var i, u = n.kind, s = "getter" === u ? "get" : "setter" === u ? "set" : "value", c = !t && e ? n.static ? e : e.prototype : null, f = t || (c ? Object.getOwnPropertyDescriptor(c, n.name) : {}), h = !1, p = r.length - 1; p >= 0; p--) {
                            var d = {};
                            for (var g in n) d[g] = "access" === g ? {} : n[g];
                            ...
                            if ("accessor" === u) {
                                ...
                                (i = l(y.get)) && (f.get = i), (i = l(y.set)) && (f.set = i), (i = l(y.init)) && o.unshift(i)
                            } else(i = l(y)) && ("field" === u ? o.unshift(i) : f[s] = i)
                        }
                    ...
                    function A(e, t, r) {
                        ...
                        function i(e, t) {
                            try {
                                (r = o[e](t)).value instanceof $ ? Promise.resolve(r.value.v).then(u, s) : c(a[0][2], r)
                            } catch (e) {
                                c(a[0][3], e)
                            }
                            var r
...
//# sourceMappingURL=https://static.parastorage.com/services/editor-elements-library/dist/corvid/rb_wixui.corvid[VectorImage].32d7168e.bundle.min.js.map