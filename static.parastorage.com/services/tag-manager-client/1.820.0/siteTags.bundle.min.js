! function() {
    ...
    function B(e, t, n) {
        const o = e.filter((e => !e.embeddedNodes)),
            r = i(n, s) ? j(o, t) : o,
            a = r.map((e => e.tag));
        b(a), P(O.TAGS_LOADING, window, a), r.forEach((e => {
            const t = e.tag,
                n = D(t.content),
                ...
                i = function(e, t, n, o) {
                    ...
                    e.forEach((e => {
                        ...
                        i.push(t), o ? n.insertBefore(t, d) : n.appendChild(t)
                    })), 0 === r && v(t.onload, {}, !0);
                    return i
                }(n, {
    ...
    function U(e, t, n, o) {
        ...
        a.open(c, d, !0), a.onreadystatechange = () => {
            if (4 === a.readyState) {
                const e = a.status;
                e < 200 || e >= 300 ? v(n, {
                    status: e,
    ...
    function H(e, t) {
        const r = o(e),
            {
                currentPageID: a,
                initConsentPolicyManager: c = !1
            } = t;
        var d, s, l, g;
        if (r.errors && r.errors.length > 0 && n(JSON.stringify(r.errors)), r.config && ((s = r.config.consentPolicy) && "object" == typeof s && (p = [...p, ...y(s)]), c && window.consentPolicyManager && window.consentPolicyManager.init({
                consentPolicy: r.config.consentPolicy
            }), "object" != typeof(d = r.config) || Array.isArray(d) || (w = { ...w,
                ...d
            })), r.tags) {
    ...
    function J(e) {
        const {
            ...
            language: a,
            categories: c
        } = e, s = q(i, t, r), u = !r && window.consentPolicyManager ? window.consentPolicyManager._getConsentPolicyHeader() : {}, l = function(e) {
        ...
        }(window), g = function(e, t) {
            void 0 === t && (t = location.search);
            let n = t.split(e + "=")[1];
            return n = n ? decodeURIComponent(n.split("&")[0]) : void 0, n
        }("omit"), f = window.wixEmbedsAPI.getAppToken;
        f && (u.authorization = v(f, d)), U(s, (e => {
            H(e, {
                initConsentPolicyManager: !c && !!r,
                currentPageID: l.id
            })
        }), (e => {
            n("Error loading site tags at " + s), n(e.message)
        }), {
            query: {
                wixSite: !!r,
                htmlsiteId: o,
    ...
    let X = () => {
        ...
        J({
            ...
            wixSite: e.isWixSite()
        }), window.wixEmbedsAPI.registerToEvent("pageNavigation", Y), document.addEventListener("consentPolicyChanged", V), window.wixTagManager = W, P(O.TAG_MANAGER_LOADED, window, W)
    };
