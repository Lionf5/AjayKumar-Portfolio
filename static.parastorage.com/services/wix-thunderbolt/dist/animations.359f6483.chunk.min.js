...
(self.webpackJsonp__wix_thunderbolt_app = self.webpackJsonp__wix_thunderbolt_app || []).push([
    [1900], {
        ...
        50803: function(t, e, i) {
            ...
            function r(t, e) {
                o.x = window.scrollX, o.y = window.scrollY, requestAnimationFrame((() => t && t(e)))
            }

            function s(t) {
                t.rect.width = window.visualViewport.width, t.rect.height = window.visualViewport.height
            }
            ...
            function c(t) {
                ...
                return t.scenes.forEach((e => {
                    var n, r;
                    e.target && e.centeredToTarget && (e.transform = (n = function(t) {
                        let e = t,
                            i = 0,
                            n = 0;
                        if (e.offsetParent)
                        ...
                        x(t) {
                            const e = n.left - o.x + n.width / 2,
                                i = e >= r.width / 2,
                                s = 2 * (i ? e : r.width - e);
                            return (t - (i ? 0 : e - s / 2)) / s
                        },
                        y(t) {
                            const e = n.top - o.y + n.height / 2,
                                i = e >= r.height / 2,
                                s = 2 * (i ? e : r.height - e);
                            return (t - (i ? 0 : e - s / 2)) / s
                        }
                    }), f = !0), t.root ? i = function(t) {
                    ...
                    }(t) : (c = s.bind(null, t), window.addEventListener("resize", c))
                })), e = function(e) {
                    ...
                    Object.assign(u, e)
                }, f && (h = r.bind(null, e, u), document.addEventListener("scrollend", h)), {
                    tick: e,
                    destroy: function() {
                        t.scenes.forEach((t => t.destroy ? .())), document.removeEventListener("scrollend", h), i ? (i.disconnect(), i = null) : (window.removeEventListener("resize", c), c = null), e = null, u = null
                    }
                }
            }
            class h {
...
//# sourceMappingURL=https://static.parastorage.com/services/wix-thunderbolt/dist/animations.359f6483.chunk.min.js.map