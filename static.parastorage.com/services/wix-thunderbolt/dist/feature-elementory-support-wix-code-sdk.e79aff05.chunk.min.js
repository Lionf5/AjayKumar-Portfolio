    ...
    [3121], {
        ...
        2145: function(e, t, r) {
            ...
            const i = "Request timed out",
                u = "Promise in backend function rejected with undefined";
            const c = 6e4;
            var s = (e, t, r, s, m, d, f, v) => ({
                baseUrl: e,
                getQueryParameters: t,
                getRequestOptions: r,
                errorTypes: n,
                setHeader: d,
                async getJSON(d, p = [], l = null) {
                    const y = t(),
                        C = r(),
                    ...
                    return new Promise((async (e, t) => {
                        ...
                        try {
                            ...
                            clearTimeout(r);
                            try {
                                const r = (0, o.vB)(JSON.stringify(i.data)),
                                    {
                                        isError: n,
                                        payload: a
                                    } = r;
                                if (n) {
                                    const e = a || new Error(u);
                                    t(e)
                                } else e(a)
                            } catch (e) {
                                t(P(n.PARSE, e.message))
                            }
                        } catch (e) {
                            t(P(n.ERROR, e.message))
                        }
                    }))
                }
            });
            const m = ({
                ...
                const {
                    ...
                    gridAppId: d,
                    siteRevision: f
                } = e, v = "site" === u && Boolean(a.experiments["specs.thunderbolt.useElementoryRelativePath"]), p = {};
                return {
                    elementorySupport: s(c, (() => ((e, t, r) => `?gridAppId=${e}&instance=${t}&viewMode=${r}`)(d, t.getWixCodeInstance(), u)), (() => ({
                        headers: {
                            "X-XSRF-TOKEN": n,
                            "x-wix-site-revision": f.toString(),
                            "x-wix-app-instance": t.getInstance(i),
                            commonConfig: r.getHeader(),
                            Authorization: t.getWixCodeInstance(),
                            ...p
                        }
                    })), o, t, ((e, t) => {
                        p[e] = t
...
//# sourceMappingURL=feature-elementory-support-wix-code-sdk.e79aff05.chunk.min.js.map