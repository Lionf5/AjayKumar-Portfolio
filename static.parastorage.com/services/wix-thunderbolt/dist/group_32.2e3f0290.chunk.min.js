    ...
    [8488], {
        58793: function(e, t, n) {
            ...
            var o = n(56510),
                ...
                a = n(67613),
                s = n(80928);
            const d = (0, o.ff)([(0, o.t6)(i.$e, a.u2), (0, o.t6)(i.Wf, a.u2), a.TR, s.i, r.ZQ], ((e, t, n, o, i) => {
            ...
            var p = n(13487),
                c = n(27451),
                g = n(55437);
            const m = (0, o.ff)([(0, o.t6)(i.$e, a.u2), g.xP, a.TR, s.i, (0, o.t6)(i.Wf, a.u2), r.ZQ], ((e, t, n, o, i, r) => ({
                componentTypes: ["Page"],
                        ...
                        SITE_PAGES: {
                            ...
                            ...l ? {} : {
                                ...
                                onTransitionComplete: () => {
                                    n.notifyPageTransitionsCompleted(p), o.getScrollYHistoryState() && o.restoreScrollPosition()
                                }
                            }
                        }
                    }), i.update((() => ({ ...s,
            ...
            const b = ["video.videoInfo.videoId", "image.uri", "image.link.href", "image.displayMode", "backgroundImage.uri", "backgroundImage.link.href", "backgroundImage.displayMode"],
                ...
                U = (e, t, n, o) => o.every((n => (e && e[n]) === (t && t[n]))) && n.every((i => !e && !t || U(e && e[i], t && t[i], n, o))),
                x = (0, o.ff)([(0, o.t6)(i.$e, a.u2), g.xP, a.TR, s.i, (0, o.t6)(i.Wf, a.u2), f.C9, f.ku], ((e, t, n, o, i, r, a) => {
                        ...
                        d = t.subscribeToChanges((n => {
                            if (s in n) {
                                const a = n[s] ? .fillLayers,
                                    ...
                                    p = i.get() ? .nextTransitionEnabled ? ? !0,
                                    c = !((e, t) => {
                                        if (!t || !e) return !1;
                                        const n = t.mediaRef,
                                            o = n && n.type,
                                        ...
                                        return s && U(t, e, ["mediaRef", "imageOverlay"], d)
                                    })(u, l),
                                    g = (o = a, !((r = d) && o && b.every((e => y().get(r, e) === y().get(o, e)))) || c);
                                i.update((e => ({ ...e,
                                    pageBackgroundProp: a,
                                    pageBackground: u
                                }))), t.update({
                                    BACKGROUND_GROUP: {
                                        transitionEnabled: p && g
                                    }
                                })
                            }
                            var o, r
                ...
                M = e => {
                    e(a.TR).to(l), e(a.M$).to(u), e(p.j.PageDidMountHandler, p.j.PageWillUnmountHandler).to(d), e(c.Vx).to(m), e(c.Vx).to(x)
                },
                k = e => {
                    e(p.j.PageDidMountHandler, p.j.PageWillUnmountHandler).to(d), e(c.Vx).to(m), e(c.Vx).to(x)
                },
                v = e => {
                    e(a.M$).to(u), e(a.TR).to(l)
                }
        }
    }
]);
