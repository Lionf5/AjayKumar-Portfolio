...
var CommonFullscreenWrapper = /** @class */ (function(_super) {
    ...
    function CommonFullscreenWrapper(props) {
        ...
        _this.shouldUseNewSocialSharePopup = true;
        return _this;
    }
    ...
    CommonFullscreenWrapper.prototype.shouldUseReactPortal = function() {
        return (this.props.viewMode !== GALLERY_v4_CONSTS.viewMode.SEO && !utils.isSSR());
    };
    ...
    CommonFullscreenWrapper.prototype.getRenderElement = function() {
        ...
        } else if (props.viewMode === GALLERY_v4_CONSTS.viewMode.SEO) {
            return (React.createElement(ProGalleryFullscreenMock, {
                items: props.viewMode === GALLERY_v4_CONSTS.viewMode.SEO ?
                    props.items :
        ...
        } else if (props.viewMode === GALLERY_v4_CONSTS.viewMode.SITE &&
            !utils.isSSR() &&
            !this.isStoreGallery()
    ...
    CommonFullscreenWrapper.prototype.render = function() {
        ...
        var fullscreen = (React.createElement("div", {
                className: "fullscreen-comp-wrapper ".concat(this.isStoreGallery() ? this.props.id : '')
            },
