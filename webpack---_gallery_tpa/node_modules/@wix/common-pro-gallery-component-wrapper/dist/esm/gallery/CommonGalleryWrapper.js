...
var CommonGalleryWrapper = /** @class */ (function(_super) {
    ...
    function CommonGalleryWrapper(props) {
        ...
        _this.setGotFirstInteractionByUser = _this.setGotFirstInteractionByUser.bind(_this);
        _this.accessibilityHelper = new AccessibilityHelper(_this, props, _this.setAccessibilityState);
        _this.syncEventHandler = new SyncEventHandler(_this, props, _this.setGotFirstInteractionByUser);
    ...
    CommonGalleryWrapper.prototype.getIsInFirstFold = function(props) {
        ...
        if (experimentsWrapper.getExperimentBoolean('specs.pro-gallery.useIsInFirstFold') &&
    ...
    CommonGalleryWrapper.prototype.setGotFirstInteractionByUser = function() {
        this.setState({
            gotFirstInteractionByUser: true
        });
    };
    ...
    CommonGalleryWrapper.prototype.componentDidMount = function() {
        ...
        addGalleryToAutofixDB({
            ...
            wixStyles: (_b = (_a = this.props.host) === null || _a === void 0 ? void 0 : _a.style) === null || _b === void 0 ? void 0 : _b.styleParams,
            galleryId: this.props.galleryId,
            dimensions: (_c = this.props.host) === null || _c === void 0 ? void 0 : _c.dimensions,
        });
    };
    ...
    CommonGalleryWrapper.prototype.shouldRenderGallery = function(_a) {
        ...
        if (this.viewMode === GALLERY_v4_CONSTS.viewMode.SEO &&
    ...
    CommonGalleryWrapper.prototype.isUnKnownContainer = function(_a) {
        ...
        var galleryRatioValue = (((_b = layoutParams === null || layoutParams === void 0 ? void 0 : layoutParams.structure) === null || _b === void 0 ? void 0 : _b.galleryRatio) || {}).value;
    ...
    CommonGalleryWrapper.prototype.getCssBaseUrl = function() {
        ...
        var widgetsUrlOverride = queryParams === null || queryParams === void 0 ? void 0 : queryParams.widgetsUrlOverride;
    ...
    CommonGalleryWrapper.prototype.render = function() {
        ...
        if (this.canRender({
            ...
            if (shouldRenderGallery && useLayoutFixer && (isPrerenderMode && !this.state.gotFirstInteractionByUser)) {
            ...
            var isFixedGalleryRatio = ((_c = (_b = (_a = options.layoutParams) === null || _a === void 0 ? void 0 : _a.structure) === null || _b === void 0 ? void 0 : _b.galleryRatio) === null || _c === void 0 ? void 0 : _c.value) > 0;
            var isVertical = options.scrollDirection === 0;
            var isLoadMoreOn = options.enableInfiniteScroll === false && !this.loadMoreClicked;
            var responsiveGallery = ((isHorizontal && !isFixedGalleryRatio) ||
                    (isVertical && isLoadMoreOn)) &&
                !(this.props.host.dimensions.height > 0);
            var galleryClassSelector = "div.".concat(id, ":not(.fullscreen-comp-wrapper)");
            rawStyle = responsiveGallery ?
                "".concat(galleryClassSelector, " {\n        height: 100%;\n        width: 100%;\n        position: relative;\n      }\n      ").concat(galleryClassSelector, " > div {\n        position: absolute;\n        top: 0;\n        left: 0;\n      }") :
                "".concat(galleryClassSelector, " {\n      width: 100%;\n      }\n      ");
        } else {
            dom = [];
            dom.push(this.createRenderIndicator({
