...
export var ProGalleryRendererWrapper = function(props) {
    ...
    var getProGalleryRole = function() {
        var removeRoleApplication = experimentsWrapper.getExperimentBoolean('specs.pro-gallery.removeRoleApplication');
        if (removeRoleApplication) {
            return "region";
        }
        return "application";
    };
    return (React.createElement(ProGalleryRenderer, {
        ...
        proGalleryRole: getProGalleryRole(),
