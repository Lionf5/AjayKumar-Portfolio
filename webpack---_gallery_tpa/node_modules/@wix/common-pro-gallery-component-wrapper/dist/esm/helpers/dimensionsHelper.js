...
var DimensionsHelper = /** @class */ (function() {
    ...
    DimensionsHelper.prototype.observeResize = function() {
        ...
        var galleryWrapperElement = window.document.getElementById("gallery-wrapper-".concat(this.id));
    ...
    DimensionsHelper.prototype.calcBoundingRect = function() {
        ...
        try {
            this.galleryWrapperElement = window.document.getElementById("gallery-wrapper-".concat(this.id));
            return this.getBoundingBox(this.galleryWrapperElement);
        } catch (e) {
            console.error('couldnt get bounding box', e);
            return false;
        }
    };
    ...
    DimensionsHelper.prototype.calcBodyBoundingRect = function() {
        ...
        try {
            ...
            if (popupRootElement &&
                ...
                return this.getBoundingBox(popupRootElement);
            } else {
                return this.getBoundingBox(window.document.body);
            }
        } catch (_a) {
            return false;
        }
    ...
    DimensionsHelper.prototype.getPreviewMobileEmulatorBoundingClientRect = function() {
        try {
            ...
            return this.getBoundingBox(this.siteContainerElement);
        } catch (e) {
            console.error(e);
        }
    };
    DimensionsHelper.prototype.isPreview = function() {
        return this.parent.viewMode === GALLERY_v4_CONSTS.viewMode.PREVIEW;
    };
    DimensionsHelper.prototype.getBoundingBox = function(element) {
        if (!element)
            return {};
        return __assign(__assign({}, this.getBoundingClientRectObject(element)), {
            width: element.offsetWidth,
            height: element.offsetHeight
        });
    };
    DimensionsHelper.prototype.getBoundingClientRectObject = function(element) {
