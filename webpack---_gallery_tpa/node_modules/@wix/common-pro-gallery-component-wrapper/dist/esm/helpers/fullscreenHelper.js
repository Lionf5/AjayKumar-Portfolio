...
var FullscreenHelper = /** @class */ (function() {
    function FullscreenHelper(galleryWrapper, props, isStore) {
        ...
        this.unSubscribeToFullscreenChangeEvent = this.unSubscribeToFullscreenChangeEvent.bind(this);
    }
    ...
    FullscreenHelper.prototype.openDirectFullscreen = function() {
        if (this.galleryWrapper.state.fullscreen.directFullscreenItem &&
            ...
            return __generator(this, function(_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (!(typeof this.galleryWrapperProps.setMetaTags === 'function')) return [3 /*break*/ , 3];
                        return [4 /*yield*/ , this.galleryWrapper.itemActionsHelper.useItemActions('pageUrl')];
                    case 2:
                        page_url = _a.sent();
                        itemData = constructMetaTagsItemData(galleryItem, page_url, fullscreen_url);
    ...
    FullscreenHelper.prototype.canUpdateUrl = function() {
        if (this.galleryWrapper.siteHelper.parseViewMode(this.galleryWrapperProps.viewMode) !== GALLERY_v4_CONSTS.viewMode.SITE) {
            return false;
        }
        return true;
    };
    FullscreenHelper.prototype.updateUrl = function(neededUrl) {
        ...
        for (var _i = 0, _a = Object.entries(queryParams); _i < _a.length; _i++) {
            var _b = _a[_i],
                key = _b[0],
                value = _b[1];
            queryPairs.push("".concat(key, "=").concat(value));
        }
    ...
    FullscreenHelper.prototype.animatedOpenFullscreen = function(itemProps) {
        ...
        var fullscreen = __assign(__assign({}, this.galleryWrapper.state.fullscreen), {
        ...
        this.setGalleryWrapperFullscreenState(fullscreen, function() {
            ...
            _this.setGalleryWrapperFullscreenState(__assign(__assign({}, _this.galleryWrapper.state.fullscreen), {
    ...
    FullscreenHelper.prototype.handleFullscreenChange = function(e) {
        this.galleryWrapper.handleDisplayChange(!e.detail.isOpen);
    };
    FullscreenHelper.prototype.dispatchFullscreenChange = function(isOpen) {
        var event = new CustomEvent('proGalleryFullscreenChange', {
            detail: {
                isOpen: isOpen
            },
        });
    ...
    FullscreenHelper.prototype.subscribeToFullscreenChangeEvent = function(callback) {
        window.document.addEventListener('proGalleryFullscreenChange', this.handleFullscreenChange, false);
    };
    FullscreenHelper.prototype.unSubscribeToFullscreenChangeEvent = function() {
        window.document.removeEventListener('proGalleryFullscreenChange', this.handleFullscreenChange, false);
    };
