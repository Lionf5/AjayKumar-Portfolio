...
function shouldRenderMasterInfo(galleryLayout) {
    var useNewInfoExp = experimentsWrapper.getExperimentBoolean('specs.pro-gallery.masterInfoElements');
...
var ItemsHelper = /** @class */ (function() {
    function ItemsHelper(galleryWrapper, props, isStoreGallery) {
        ...
        this.areOneOrMoreItemsCorrupted = this.areOneOrMoreItemsCorrupted.bind(this);
        this.getMoreItems = this.getMoreItems.bind(this);
        this.processPgItemPropsForInfoElement = this.processPgItemPropsForInfoElement.bind(this);
                    ...
                    return __generator(this, function(_b) {
                        switch (_b.label) {
                            case 0:
                                ...
                                url = "https://www.wix.com/_api/albums-node-server/getSecuredFileUrl?galleryId=".concat(galleryId, "&instanceId=").concat(srcId, "&itemId=").concat(itemId, "&mediaUrl=").concat(mediaUrl);
    ...
    ItemsHelper.prototype.shouldTextBeOnRequestedInfoType = function(requestedInfoType, titlePlacement, isSlideshow) {
        switch (requestedInfoType) {
            ...
            case EXTERNAL_INFO_TYPE.EXTERNAL:
                return (GALLERY_v4_CONSTS.hasExternalVerticalPlacement(titlePlacement) ||
    ...
    ItemsHelper.prototype.renderInfoElement = function(type, pgItemProps) {
        var shouldUseMasterInfo = shouldRenderMasterInfo(this.galleryWrapperProps.options.galleryLayout);
        if (shouldUseMasterInfo) {
            ...
            return renderMasterInfoElements(type, query, this.galleryWrapper.props, this.shouldUseNewSocialSharePopup, pgItemProps, shouldControlHorizontalAlignment, shouldUseLineHeightFixer, shouldInsertDefaults);
        }
        var InfoElement = this.infoElement ||
            (this.shouldTextBeOnRequestedInfoType(type, pgItemProps.options.titlePlacement, this.isSlideshow(pgItemProps)) ?
                TextInfoElement :
                null);
    ...
    ItemsHelper.prototype.customImageRenderer = function(props) {
        var _a, _b, _c, _d;
        if (experimentsWrapper.getExperimentBoolean('specs.pro-gallery.useUnchangingImageRenderer') &&
            ![
            ...
            if (!((_b = (_a = this.galleryWrapper) === null || _a === void 0 ? void 0 : _a.state) === null || _b === void 0 ? void 0 : _b.gotFirstInteractionByUser)) {
            ...
            var ImageRendererProps = __assign(__assign({}, props), {
                allowChanges: !!((_d = (_c = this.galleryWrapper) === null || _c === void 0 ? void 0 : _c.state) === null || _d === void 0 ? void 0 : _d.gotFirstInteractionByUser),
                priorityLoading: priorityLoading
            });
            return React.createElement(UnchangingImageRenderer, __assign({}, ImageRendererProps));
        }
        if (experimentsWrapper.getExperimentBoolean('specs.pro-gallery.useWowImageRenderer')) {
            return React.createElement(WowImageRenderer, __assign({}, props));
        }
        if (experimentsWrapper.getExperimentBoolean('specs.pro-gallery.useStagedCustomImageRenderer')) {
            return React.createElement(StagedCustomImageRenderer, __assign({}, props));
        } else {
