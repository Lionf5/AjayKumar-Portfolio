...
var SiteHelper = /** @class */ (function() {
    function SiteHelper(galleryWrapper, props, isStoreGallery) {
        this.TPADimensionsHelper = new tpaDimensionsHelper();
        ...
        this.getPreviewMobileEmulatorWidth = this.getPreviewMobileEmulatorWidth.bind(this);
        this.getPreviewMobileEmulatorLeft = this.getPreviewMobileEmulatorLeft.bind(this);
    }
    ...
    SiteHelper.prototype.parseViewMode = function(viewMode) {
        if (this.galleryWrapperProps.isInSEO) {
            return GALLERY_v4_CONSTS.viewMode.SEO;
        }
    ...
    SiteHelper.prototype.handleNewGalleryStructure = function(newGalleryStructureData) {
        ...
        var numOfItems = newGalleryStructureData.numOfItems,
            ...
            isFixedHorizontlaGalleryRatio = newGalleryStructureData.isFixedHorizontlaGalleryRatio,
        ...
        this.TPADimensionsHelper.setWixHeight({
            height: layoutHeight,
            offsetTop: 0,
            styleParams: options,
            container: container,
    ...
    SiteHelper.prototype.isMobile = function() {
        return this.galleryWrapper.deviceType === GALLERY_v4_CONSTS.deviceType.MOBILE;
    };
    return SiteHelper;
}());
