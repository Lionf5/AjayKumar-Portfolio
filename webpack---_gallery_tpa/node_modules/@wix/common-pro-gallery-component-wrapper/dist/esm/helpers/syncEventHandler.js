...
var SyncEventHandler = /** @class */ (function() {
    function SyncEventHandler(galleryWrapper, galleryWrapperProps, setGotFirstInteractionByUser) {
        ...
        this.setFirstInteractionCallback = setGotFirstInteractionByUser;
    ...
    SyncEventHandler.prototype.eventHandler = function(eventName, eventData) {
        ...
        var whiteListedEvents = [
            GALLERY_v4_CONSTS.events.LOAD_MORE_CLICKED,
            GALLERY_v4_CONSTS.events.ITEM_ACTION_TRIGGERED,
            GALLERY_v4_CONSTS.events.CURRENT_ITEM_CHANGED,
            GALLERY_v4_CONSTS.events.NEED_MORE_ITEMS,
            INFO_EVENTS.SHARE_BUTTON_CLICKED,
            INFO_EVENTS.TEXT_DOWNLOAD_BUTTON_CLICKED,
            INFO_EVENTS.LOVE_BUTTON_CLICKED,
            GALLERY_v4_CONSTS.events.ITEM_CLICKED,
            INFO_EVENTS.DOWNLOAD_BUTTON_CLICKED,
            INFO_EVENTS.CUSTOM_BUTTON_CLICKED,
            INFO_EVENTS.SOCIAL_SHARE_BUTTON_CLICKED,
            GALLERY_v4_CONSTS.events.THUMBNAIL_CLICKED,
            GALLERY_v4_CONSTS.events.ITEM_FOCUSED,
            GALLERY_v4_CONSTS.events.ITEM_LOST_FOCUS,
            GALLERY_v4_CONSTS.events.GALLERY_SCROLLED,
        ];
        if (!this.firstInteractionRegistered) {
            var firstActionEvents = [
                GALLERY_v4_CONSTS.events.HOVER_SET,
                GALLERY_v4_CONSTS.events.GALLERY_SCROLLED,
                GALLERY_v4_CONSTS.events.LOAD_MORE_CLICKED,
                GALLERY_v4_CONSTS.events.ITEM_ACTION_TRIGGERED,
                GALLERY_v4_CONSTS.events.ITEM_CLICKED,
            ];
            if (firstActionEvents.includes(eventName)) {
                this.setFirstInteractionCallback();
