...
var SocialShareWrapper = /** @class */ (function(_super) {
    ...
    SocialShareWrapper.prototype.getSocialShareScreenIfNeeded = function() {
        if (this.props.deviceType === GALLERY_v4_CONSTS.deviceType.MOBILE) {
    ...
    SocialShareWrapper.prototype.displayMobileWebShareApi = function() {
        ...
        if (navigator.share) {
            ...
            navigator
                ...
                .catch(function(e) {
                    console.error("Couldnt use WebShareApi. error: ".concat(e));
    ...
    SocialShareWrapper.prototype.render = function() {
        if (this.props.showSocialSharePopup) {
            var socialPopup = void 0;
            if (this.props.deviceType === GALLERY_v4_CONSTS.deviceType.MOBILE &&
                !utils.isiOS()) {
                // Anroid device --> use Mobile native Web Share API
                socialPopup = this.displayMobileWebShareApi();
            } else {
                // Desktop and iOS
                socialPopup = this.displaySocailShareScreen();
            }
            return ReactDOM.createPortal(socialPopup, document.body);
        } else {
            return null;
        }
    };
