...
var GalleryContainer = /** @class */ (function(_super) {
    ...
    function GalleryContainer(props) {
        ...
        _this.updateVisibility = function() {
            var isInViewport = isGalleryInViewport({
                container: _this.props.container,
                scrollTop: _this.state.scrollPosition.top,
            });
            if (_this.state.isInViewport !== isInViewport) {
                _this.setState({
                    isInViewport: isInViewport,
                });
            }
        };
        _this.setVisibilityIfNeeded = function(prevProps, prevState) {
            var container = _this.props.container;
            var scrollPosition = _this.state.scrollPosition;
            if (container.scrollBase !== prevProps.container.scrollBase ||
    ...
    GalleryContainer.prototype.isScrollingUnavailable = function(height, viewportHeight) {
        var extraPadding = 300;
    ...
    GalleryContainer.prototype.getMoreItemsIfScrollIsDisabled = function(height, viewportHeight) {
        return __awaiter(this, void 0, void 0, function() {
            var lastItemsCount_1;
            var _this = this;
            return __generator(this, function(_a) {
                ...
                if (this.isScrollingUnavailable(height, viewportHeight)) {
                    lastItemsCount_1 = this.state.items.length;
                    // Trying to get more items
                    this.getMoreItemsIfNeeded(0).then(function() {
                        // No need to continue calling if no items are left to fetch
                        if (_this.state.items.length > lastItemsCount_1) {
                            var body = document.body,
                                html = document.documentElement;
                            var viewportHeight_1 = window.innerHeight;
                            var height_1 = Math.max(body.scrollHeight, body.offsetHeight, html.clientHeight, html.scrollHeight, html.offsetHeight);
                            _this.getMoreItemsIfScrollIsDisabled(height_1, viewportHeight_1);
                        }
                    });
                }
                return [2 /*return*/ ];
    ...
    GalleryContainer.prototype.handleNewGalleryStructure = function() {
        ...
        var layoutHeight = updatedHeight || this.props.container.height;
        var layoutItems = this.props.structure.items;
        var isFixedHorizontlaGalleryRatio = this.containerInfiniteGrowthDirection() === 'horizontal' &&
        ...
        var onGalleryChangeData = {
            ...
            isFixedHorizontlaGalleryRatio: isFixedHorizontlaGalleryRatio,
    ...
    GalleryContainer.prototype.getScrollingElement = function() {
        ...
        var horizontal = function() {
            return window.document.querySelector("#pro-gallery-" + _this.props.id + " #gallery-horizontal-scroll-" + _this.props.id);
        };
    ...
    GalleryContainer.prototype.scrollToItem = function(itemIdx, fixedScroll, isManual, durationInMS, scrollMarginCorrection, isContinuousScrolling) {
        ...
        if (itemIdx >= 0) {
            ...
            try {
                ...
                return this.currentScrollData.scrollDeffered.promise.then(function() {
                    _this.currentScrollData = null;
                });
            } catch (e) {
    ...
    GalleryContainer.prototype.onGalleryScroll = function(scrollPosition) {
    ...
    GalleryContainer.prototype.simulateHorizontalScrollToItem = function(item) {
        (item === null || item === void 0 ? void 0 : item.offset) && this.onGalleryScroll({
    ...
    GalleryContainer.prototype.eventsListener = function(eventName, eventData, event) {
        ...
        if (eventName === GALLERY_CONSTS.events.GALLERY_SCROLLED) {
            ...
            var newScrollPosition = __assign(__assign({}, this.state.scrollPosition), eventData);
            this.setState({
    ...
    GalleryContainer.prototype.getMoreItemsIfNeeded = function(scrollPos) {
        var _this = this;
        var _a;
        if ((_a = this.deferredGettingMoreItems) === null || _a === void 0 ? void 0 : _a.isPending) {
            ...
            if (!(this.galleryStructure &&
                ...
                var scrollDirection = this.state.options.scrollDirection;
                ...
                var screenSize = window[scrollDirection === GALLERY_CONSTS.scrollDirection.HORIZONTAL ?
                    'innerWidth' :
                    'innerHeight'];
                ...
                if (galleryEnd < getItemsDistance + scrollEnd) {
                    ...
                    setTimeout(function() {
                        ...
                        _this.deferredGettingMoreItems.resolve();
                    }, 2000);
                } else {
                    // No items are fetched -> reject
                    this.deferredGettingMoreItems.reject();
        ...
        return this.deferredGettingMoreItems.promise.catch(function() {});
    };
    ...
    GalleryContainer.prototype.onMouseEnter = function() {
        var _a;
        if (((_a = this.currentScrollData) === null || _a === void 0 ? void 0 : _a.isContinuousScrolling) &&
    ...
    GalleryContainer.prototype.render = function() {
        ...
        return (React.createElement("div", {
            ...
            React.createElement(ViewComponent, __assign({
                ...
                scrollTop: (_b = (_a = this.state) === null || _a === void 0 ? void 0 : _a.scrollPosition) === null || _b === void 0 ? void 0 : _b.top,
            ...
            }, (_c = this.props.translations) === null || _c === void 0 ? void 0 : _c.Accessibility_Left_Gallery))));
    };
