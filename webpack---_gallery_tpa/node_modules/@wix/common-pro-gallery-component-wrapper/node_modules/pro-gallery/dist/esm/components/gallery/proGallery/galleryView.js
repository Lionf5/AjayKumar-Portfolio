...
var GalleryView = /** @class */ (function(_super) {
        ...
        if (activeItemIdx) {
            ...
            switch (e.keyCode || e.charCode) {
                ...
                case 40: //down
                    ...
                    if (this.props.totalItemsCount - 1 === newIdx &&
    ...
    GalleryView.prototype.createGallery = function(showMore) {
        ...
        var _b = this.props,
            ...
            galleryStructure = _b.galleryStructure,
            getVisibleItems = _b.getVisibleItems,
            virtualizationSettings = _b.virtualizationSettings,
        ...
        var galleryWidth = this.props.isPrerenderMode ?
            'auto' :
            this.props.container.galleryWidth - options.imageMargin;
        var items = getVisibleItems(galleryStructure.galleryItems, container);
        var itemsWithVirtualizationData = getItemsInViewportOrMarginByScrollLocation({
            items: items,
            options: options,
        ...
        var layout = itemsWithVirtualizationData.map(function(_a, index) {
            var item = _a.item,
                shouldRender = _a.shouldRender;
            var itemProps = item.renderProps(__assign(__assign({}, galleryConfig), {
                visible: item.isVisible,
                key: "itemView-" + item.id + "-" + index
            }));
            return React.createElement(itemView, __assign(__assign({}, itemProps), {
    ...
    GalleryView.prototype.render = function() {
        if (utils.isVerbose()) {
            ...
            console.log('[DEBUG_RENDER] GalleryView props have changed', utils.printableObjectsDiff(this.lastProps || {}, this.props));
