...
export function NavigationArrows(_a) {
    ...
    var mouseCursorEnabled = arrowsPosition === GALLERY_CONSTS.arrowsPosition.MOUSE_CURSOR;
    ...
    var verticalPositionFix = (_b = {},
        ...
        _b[GALLERY_CONSTS.arrowsVerticalPosition.IMAGE_CENTER] = infoHeight * directionFix,
        _b[GALLERY_CONSTS.arrowsVerticalPosition.INFO_CENTER] = -imageHeight * directionFix,
    ...
    var prevContainerStyle = {
        left: mouseCursorEnabled ? 0 : arrowsPos
    };
    var nextContainerStyle = {
        right: mouseCursorEnabled ? 0 : arrowsPos
    };
    ...
    var renderArrow = function(directionIsLeft) {
        return (React.createElement(ArrowRenderHandler, __assign({}, {
    ...
    return (React.createElement(ArrowsContainer, {
            hideLeftArrow: hideLeftArrow,
            hideRightArrow: hideRightArrow,
...
export function ArrowButton(_a) {
    ...
    var buttonProps = (_b = {
        ...
        _b.style = __assign(__assign({}, containerStyle), (directionIsLeft ? prevContainerStyle : nextContainerStyle)),
        _b);
    if (cursor) {
        ...
        return (React.createElement("button", __assign({
            ...
            }, renderArrowSvg(directionIsLeft ? 'left' : 'right')), window.document.getElementById(navigationArrowPortalId))));
    }
    return (React.createElement("button", __assign({}, buttonProps), renderArrowSvg(directionIsLeft ? 'left' : 'right')));
}
export function ArrowButtonWithCursorController(props) {
    ...
    return (React.createElement(ArrowFollower, {
        id: props.id,
        mouseCursorContainerMaxWidth: mouseCursorContainerMaxWidth,
        onNavigate: function() {
            return next({
...
export function ArrowsContainer(_a) {
    ...
    if (mouseCursorEnabled) {
        ...
        return (React.createElement("div", {
                ...
                style: __assign({}, styleForMouseCursor)
            },
