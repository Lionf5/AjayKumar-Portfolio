...
var NavigationPanel = /** @class */ (function(_super) {
    ...
    NavigationPanel.prototype.createThumbnails = function(_a) {
        ...
        var clearedGalleryItems = clearGalleryItems(this.props.items, this.props.galleryStructure.galleryItems);
        var activeIndex = utils.inRange(this.props.activeIndex, clearedGalleryItems.length);
        ...
        return (React.createElement("div", {
                ...
                }, thumbnailsMargins), getNavigationPanelOnGalleryPositionStyles({
            ...
            React.createElement("div", {
                ...
                }, thumbnailItem.type === 'text' ? (React.createElement(TextItem, __assign({}, _this.props, thumbnailItem.renderProps(), {
...
export var getCustomNavigationPanelInlineStyles = function(_a) {
    var galleryHeight = _a.galleryHeight,
        ...
        galleryThumbnailsAlignment = _a.galleryThumbnailsAlignment,
        navigationPanelPosition = _a.navigationPanelPosition;
    return __assign(__assign(__assign({}, getCustomNavigationPanelDimensions({
        galleryHeight: galleryHeight,
        galleryWidth: galleryWidth,
        height: height,
        width: width,
