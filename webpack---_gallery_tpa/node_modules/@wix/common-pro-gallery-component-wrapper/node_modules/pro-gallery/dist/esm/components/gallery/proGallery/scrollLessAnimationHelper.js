...
export var toggleScrollLessAnimation = function(callback) {
    var toggleDeckTransitions = function(isPaused) {
        ...
        ['.gallery-item-wrapper', '.gallery-item-common-info-outer'].forEach(function(className) {
            if (isPaused) {
                __spreadArrays(document.querySelectorAll(className)).forEach(function(item) {
                    var _a;
