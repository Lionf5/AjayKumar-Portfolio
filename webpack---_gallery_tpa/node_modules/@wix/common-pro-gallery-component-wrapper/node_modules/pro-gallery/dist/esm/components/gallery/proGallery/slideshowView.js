...
import {
    getItemsInViewportOrMarginByActiveGroup
} from '../../helpers/virtualization';
import {
    NavigationArrows
} from './navigationArrows.js';
import {
    shouldRenderNavArrows
} from '../../helpers/navigationArrowUtils.js';
import {
    toggleScrollLessAnimation
} from './scrollLessAnimationHelper';
...
var SlideshowView = /** @class */ (function(_super) {
    ...
    function SlideshowView(props) {
        ...
        _this.autoScrollToNextItem = function() {
            if (!isEditMode() && (_this.props.isInViewport || isPreviewMode())) {
                ...
                } else if (options.autoSlideshowType === GALLERY_CONSTS.autoSlideshowTypes.INTERVAL) {
                    _this._next({
                        direction: direction,
                        isAutoTrigger: true,
                        scrollDuration: 800,
        ...
        _this.getCustomNavigationPanel = function() {
            var _a;
            if (typeof((_a = _this.props.customComponents) === null || _a === void 0 ? void 0 : _a.EXPERIMENTAL_customNavigationPanelRenderer) === 'function') {
        ...
        _this.createOrGetCustomNavigationPanelAPI = function() {
            ...
            return (_this.navigationPanelAPI ||
                (_this.navigationPanelAPI = {
                    ...
                    isAbleToNavigateNext: function() {
                        return isRTL ? !_this.state.hideLeftArrow : !_this.state.hideRightArrow;
                    },
                    isAbleToNavigateBack: function() {
                        return isRTL ? !_this.state.hideRightArrow : !_this.state.hideLeftArrow;
                    },
                    ...
                    triggerItemAction: function(e, _a) {
                        ...
                        var item = _this.props.galleryStructure.galleryItems[itemIndex % _this.props.totalItemsCount];
                        var props = item === null || item === void 0 ? void 0 : item.renderProps(__assign(__assign({}, galleryConfig), {
                            visible: true
                        }));
                        _this.props.actions.eventsListener(GALLERY_CONSTS.events.ITEM_ACTION_TRIGGERED, props, e);
                    },
                    // nextGroup,
                    // previousItem,
                    // previousGroup,
        ...
        _this._setCurrentItemByScroll = utils
            ...
            .bind(_this);
        _this._next = utils
            .throttle(_this.nextWithEffects.bind(_this), props.isScrollLessGallery ? 600 : 400)
            .bind(_this);
    ...
    SlideshowView.prototype.next = function(_a) {
        ...
        return __awaiter(this, void 0, void 0, function() {
            var scrollingUpTheGallery, activeElement, galleryItemIsFocused, avoidIndividualNavigation, ignoreScrollPosition;
            return __generator(this, function(_e) {
                ...
                galleryItemIsFocused = activeElement.className &&
                    activeElement.className.includes('gallery-item-container');
                avoidIndividualNavigation = !isKeyboardNavigation ||
                ...
                if (avoidIndividualNavigation && this.props.options.groupSize > 1) {
                    return [2 /*return*/ , this.nextGroup({
                        direction: direction,
            ...
            return __generator(this, function(_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        _b.sent();
                        if (!(this.props.options.groupSize === 1 &&
                                !this.props.isScrollLessGallery)) return [3 /*break*/ , 4];
    ...
    SlideshowView.prototype.getCenteredItemOrGroupIdxByScroll = function(key) {
        ...
        if (scrollPositionAtTheMiddleOfTheGallery === 0) {
            ...
            for (var itemOrGroup = void 0, i = 0;
                ...
                var itemOrGroupLeft = key === 'galleryItems' ? itemOrGroup.offset.left : itemOrGroup.left;
    ...
    SlideshowView.prototype.setCurrentItemByScroll = function() {
        ...
        var isScrolling = (this.scrollElement &&
    ...
    SlideshowView.prototype.getBufferedItems = function(galleryGroups, container) {
        var _a;
        var _b = this,
            state = _b.state,
            props = _b.props;
        ...
        var galleryWidth = ((_a = this.props.galleryContainerRef) === null || _a === void 0 ? void 0 : _a.clientWidth) ||
    ...
    SlideshowView.prototype.createGallery = function() {
        ...
        var galleryStyle = __assign(__assign(__assign({}, galleryDimensions), galleryStyleForExternalArrows), mouseCursorContainerStyle);
        return (React.createElement("div", {
    ...
    SlideshowView.prototype.createAutoSlideShowPlayButton = function() {
        ...
        var imageMargin = this.props.options.imageMargin / 2 + (this.isFullWidthGallery() ? 50 : 0);
    ...
    SlideshowView.prototype.getNavigationPanelArray = function() {
        ...
        if (customNavigationPanelRenderer) {
            var _a = this.props.container,
                ...
                height = _a.height,
                width = _a.width;
            var galleryThumbnailsAlignment_1 = this.props.options.galleryThumbnailsAlignment;
            var navigationPanelPosition_1 = this.props.options.layoutParams.thumbnails.position;
            var customNavigationPanelInlineStyles = getCustomNavigationPanelInlineStyles({
            ...
            navigationPanel = (React.createElement("div", {
                className: "custom-navigation-panel",
                style: customNavigationPanelInlineStyles
            }, customNavigationPanelRenderer(__assign(__assign({}, this.props), {
                activeIndex: this.state.activeIndex,
                navigationToIdxCB: this.scrollToThumbnail,
                navigationPanelAPI: this.createOrGetCustomNavigationPanelAPI()
            }))));
        } else {
            navigationPanel = (React.createElement(NavigationPanel, __assign({}, this.props, {
                activeIndex: this.state.activeIndex,
                navigationToIdxCB: this.scrollToThumbnail
            })));
        }
        var navigationPanelPosition = this.props.options.layoutParams.thumbnails.position;
        var galleryThumbnailsAlignment = this.props.options.galleryThumbnailsAlignment;
        var navigationPanels = [];
        if (navigationPanelPosition === GALLERY_CONSTS.thumbnailsPosition.ON_GALLERY) {
    ...
    SlideshowView.prototype.updateAutoSlideShowState = function(props) {
        ...
        if (shouldBlockAutoSlideshow !== shouldBlock) {
            this.setState({
                shouldBlockAutoSlideshow: shouldBlock
            }, function() {
    ...
    SlideshowView.prototype.componentDidMount = function() {
        this.scrollElement = window.document.querySelector("#pro-gallery-" + this.props.id + " #gallery-horizontal-scroll-" + this.props.id);
