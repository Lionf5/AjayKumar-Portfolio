...
var GroupView = /** @class */ (function(_super) {
    ...
    GroupView.prototype.createDom = function(visible, empty) {
        ...
        return this.props.items.map(function(item) {
            var props = item.renderProps(__assign(__assign({}, _this.props.galleryConfig), {
                visible: visible
            }));
            return React.createElement(itemView, __assign(__assign({}, props), {
                type: (empty !== null && empty !== void 0 ? empty : false) ? 'dummy' : props.type
            }));
        });
    };
    ...
    GroupView.prototype.render = function() {
        ...
        }, this.createDom(this.isVisible(), this.props.shouldRenderEmpty))) : null;
    };
    return GroupView;
}(React.Component));
