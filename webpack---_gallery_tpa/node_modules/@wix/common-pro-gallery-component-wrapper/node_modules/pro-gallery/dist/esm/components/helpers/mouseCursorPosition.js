...
export function mouseFollower(container) {
    ...
    function onMouseEnter(event) {
        ...
        (_a = emitter.call).mouseEnterState.apply(_a, __spreadArrays([!isHoveringClickableElement.apply(void 0, __spreadArrays([container, event], position))], position));
    }
...
var isHoveringClickableElement = function(element, e, x, y) {
    ...
    var elementUnderMouse = document.elementFromPoint(x + bounding.left, y + bounding.top);
...
var ArrowFollower = /** @class */ (function(_super) {
    ...
    function ArrowFollower() {
        ...
        _this.shouldRender = function(x) {
            ...
            var realMaxWidth = Math.min(_this.props.mouseCursorContainerMaxWidth, _this.props.isTheOnlyArrow ? 100 : 50);
        ...
        return (React.createElement(MouseCursor, {
            ...
            render: function(x, y) {
                ...
                return (React.createElement(React.Fragment, null,
                    ...
                    React.createElement("style", null, "\n                  #" + ((_a = getContainerById(_this.props.id)) === null || _a === void 0 ? void 0 : _a.id) + " * {\n                    cursor: none !important;\n                  }\n              ")));
            },
    ...
    return proxy(function(name) {
        if (!instances.get(name)) {
            instances.set(name, function(props) {
                var _a;
                return React.createElement(name, __assign(__assign({}, props), (_a = {}, _a[CLICKABLE_ATTR] = 'true', _a)));
            });
        }
