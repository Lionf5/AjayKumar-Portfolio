...
export var getArrowsRenderData = function(arrowsDataRelevantArgs) {
    ...
    if (customNavArrowsRenderer) {
        var size_1 = containerStyleType === GALLERY_CONSTS.arrowsContainerStyleType.BOX ?
            arrowsSize / 2.4 :
            arrowsSize;
    ...
    var arrowRenderer = function(position) {
        ...
        var style = {
            ...
            fill: utils.isMobile() && (arrowsColor === null || arrowsColor === void 0 ? void 0 : arrowsColor.value) ? arrowsColor.value : '',
        };
        return React.createElement(arrowData.SvgComp, {
            style: style
        });
    };
    return {
...
var arrowsWillFitPosition = function(arrowsWillFitPositionRelevantArgs) {
    ...
    var navArrowsContainerHeight = getArrowsSizeData({
        ...
        arrowsSize: arrowsSize,
        svgData: arrowData,
        containerStyleType: layoutParams.navigationArrows.container.containerStyleType,
