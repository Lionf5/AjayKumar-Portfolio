...
import {
    Deferred
} from '../gallery/proGallery/galleryHelpers';
...
function horizontalCssScrollTo(_a) {
    ...
    var scrollDeffered = new Deferred();
    var currentScrollEndTimeout = setTimeout(function() {
    ...
    return {
        ...
        isContinuousScrolling: isContinuousScrolling,
        autoSlideshowContinuousSpeed: autoSlideshowContinuousSpeed,
        currentScrollEndTimeout: currentScrollEndTimeout,
    };
}

function animateStopScroll(_a) {
    var scroller = _a.scroller,
        at = _a.at,
        isRTL = _a.isRTL;
    Object.assign(scroller.style, {
    ...
    var scrollDeffered = new Deferred();
    Object.assign(scroller.firstChild.style, {
        transition: "none",
        '-webkit-transition': "none",
    }, {
        transform: "translateX(0px)",
...
export function haltScroll(_a) {
    var scroller = _a.scroller,
        from = _a.from,
        isRTL = _a.isRTL,
        currentScrollEndTimeout = _a.currentScrollEndTimeout,
        scrollDeffered = _a.scrollDeffered;
    clearTimeout(currentScrollEndTimeout);
    var scrollerInner = scroller.firstChild;
    var computedStyle = getComputedStyle(scrollerInner);
    var transform = computedStyle.getPropertyValue('transform');
    var matrix = new DOMMatrix(transform);
    var margins = Math.round(parseInt(matrix.m41, 10));
    from = from - margins;
    animateStopScroll({
        scroller: scroller,
        at: from,
