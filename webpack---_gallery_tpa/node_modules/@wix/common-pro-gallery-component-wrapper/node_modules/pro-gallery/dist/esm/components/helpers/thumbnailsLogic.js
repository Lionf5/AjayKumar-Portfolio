...
function calculateActiveIndexOffset(_a) {
    ...
    if (jumpBackwardRoute < jumpForwardRoute &&
...
export function getThumbnailsData(_a) {
    ...
    var horizontalThumbnails = thumbnailAlignment === GALLERY_CONSTS.thumbnailsAlignment.BOTTOM ||
    ...
    var numberOfThumbnails = minNumOfThumbnails % 2 === 1 ? minNumOfThumbnails : minNumOfThumbnails + 1;
...
function getThumbnailsStyles(_a) {
    ...
    return __assign(__assign({}, baseStyle), (_b = {}, _b[unit] = distance < initialCenter ? 0 : initialCenter - distance, _b));
}
...
function getThumbnailLocation(_a) {
    ...
    if (horizontalThumbnails) {
        return _b = {},
            _b[isRTL ? 'right' : 'left'] = offsetSize,
            _b;
    }
    return _c = {},
        _c[isRTL ? 'bottom' : 'top'] = offsetSize,
        _c;
}
