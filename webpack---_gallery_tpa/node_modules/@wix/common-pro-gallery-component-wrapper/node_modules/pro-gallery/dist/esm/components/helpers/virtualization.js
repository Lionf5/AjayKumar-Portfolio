...
export function getItemsInViewportOrMarginByActiveGroup(_a) {
    ...
    var isHorizontal = options.scrollDirection === GALLERY_CONSTS.scrollDirection.HORIZONTAL;
    var isScrollable = !isHorizontal ||
    ...
    var activeGroupIndex = groups.findIndex(function(group) {
        ...
        var firstIndex = (_a = first.idx) !== null && _a !== void 0 ? _a : first.fullscreenIdx;
        var lastIndex = (_b = last.idx) !== null && _b !== void 0 ? _b : last.fullscreenIdx;
    ...
    for (var index = 1; accoumilatedRightMargin < rightRenderBuffer ||
        accoumilatedLeftMargin < leftRenderBuffer; index++) {
    ...
    return groups.map(function(group) {
        return {
            group: group,
            shouldRender: groupsToRender.includes(group)
        };
    });
}
