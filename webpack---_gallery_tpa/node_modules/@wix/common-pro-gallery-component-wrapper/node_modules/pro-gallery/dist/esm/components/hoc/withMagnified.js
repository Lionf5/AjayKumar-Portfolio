...
function withMagnified(WrappedComponent) {
    return /** @class */ (function(_super) {
        ...
        class_1.prototype.getPreloadImage = function() {
            var _a;
            var _b = this.props,
                createUrl = _b.createUrl,
                id = _b.id,
                style = _b.style,
                imageDimensions = _b.imageDimensions,
                options = _b.options;
            ...
            var _c = this.state,
                shouldMagnify = _c.shouldMagnify,
                x = _c.x,
                y = _c.y;
            ...
            return (React.createElement(ImageRenderer, {
                ...
                customImageRenderer: (_a = this.props.customComponents) === null || _a === void 0 ? void 0 : _a.customImageRenderer
            }));
        };
        class_1.prototype.getHighResImage = function() {
            var _a;
            var _b = this.props,
                createMagnifiedUrl = _b.createMagnifiedUrl,
                id = _b.id,
                alt = _b.alt,
                options = _b.options;
            var _c = this.getMagnifiedDimensions(),
                magnifiedWidth = _c.magnifiedWidth,
                magnifiedHeight = _c.magnifiedHeight;
