...
var ImageItem = /** @class */ (function(_super) {
    ...
    ImageItem.prototype.getImageContainerClassNames = function() {
        var _a = this.props,
            isCurrentHover = _a.isCurrentHover,
            options = _a.options,
    ...
    ImageItem.prototype.getImageElement = function() {
        ...
        var image = function() {
                ...
                switch (options.imageLoadingMode) {
                    case GALLERY_CONSTS.loadingMode.BLUR:
                        preload = (React.createElement(ImageRenderer, __assign({
                            ...
                            customImageRenderer: (_a = _this.props.customComponents) === null || _a === void 0 ? void 0 : _a.customImageRenderer
                        })));
                        break;
                    case GALLERY_CONSTS.loadingMode.MAIN_COLOR:
                        preload = (React.createElement(ImageRenderer, __assign({
                            ...
                            customImageRenderer: (_b = _this.props.customComponents) === null || _b === void 0 ? void 0 : _b.customImageRenderer
                        })));
                        break;
            ...
            var src = createUrl(imageType, GALLERY_CONSTS.urlTypes.HIGH_RES);
            var highres = (React.createElement(ImageRenderer, __assign({
                ...
                loading: _this.props.isPrerenderMode ? 'lazy' : 'eager',
                style: __assign(__assign(__assign({}, imageSizing), blockDownloadStyles), (!shouldRenderHighResImages && preloadStyles))
            }, imageProps, {
                customImageRenderer: (_d = _this.props.customComponents) === null || _d === void 0 ? void 0 : _d.customImageRenderer
            })));
