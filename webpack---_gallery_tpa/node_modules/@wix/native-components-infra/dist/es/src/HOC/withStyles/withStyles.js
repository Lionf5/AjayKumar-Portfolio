...
export var withStyles = function(Component, options) {
    ...
    var WithStyles = function(props) {
        ...
        var _a = React.useState(function() {
            ...
            loaded = _a[0],
            setLoaded = _a[1];
        var style = props.style || (host === null || host === void 0 ? void 0 : host.style);
        ...
        }, [JSON.stringify(style), JSON.stringify(host === null || host === void 0 ? void 0 : host.dimensions), isRTL, isMobile, isEditorX, prefixSelector]);
        var cssVars = React.useMemo(function() {
            var siteCssVars = getSiteCssVariables(style.siteColors, style.siteTextPresets);
            var widgetCssVars = getComponentCssVariables(style, {}, {}, {
                prefixSelector: prefixSelector,
                isRTL: !!isRTL,
                isMobile: !!isMobile,
                isEditorX: !!isEditorX,
                strictMode: !!options.strictMode,
                dimensions: host && host.dimensions,
            }, options.defaults, options.customCssVars);
            return "".concat(prefixSelector, " {\n            ").concat(siteCssVars.stylesheet, "\n            ").concat(widgetCssVars.stylesheet, "\n        }");
        }, [JSON.stringify(style), JSON.stringify(host === null || host === void 0 ? void 0 : host.dimensions), isRTL, isMobile, isEditorX, prefixSelector]);
        var staticCss = React.useMemo(function() {
            return getStaticCss(prefixStaticCss && prefixSelector ? {
                prefixSelector: prefixSelector
            } : undefined);
        ...
        return (React.createElement("div", {
            ...
            null,
            cssVars && React.createElement("style", {
