...
var tpaDimensionsHelper = /** @class */ (function() {
    ...
    tpaDimensionsHelper.prototype.getViewportScaleRatio = function(isResponsive) {
    ...
    tpaDimensionsHelper.prototype.setWixHeight = function(_a) {
        ...
        var height = _a.height,
            ...
            isFixedHorizontlaGalleryRatio = _a.isFixedHorizontlaGalleryRatio,
        ...
        var getMaxRowHeight = function() {
            ...
            var addLayoutHeight = function() {
                return (styleParams.hasThumbnails && ['top', 'bottom'].indexOf(styleParams.galleryThumbnailsAlignment) >= 0 ?
                        styleParams.thumbnailSize || 120 :
                        0) +
                    (styleParams.externalInfoHeight > 0 ?
                        styleParams.externalInfoHeight :
                        0);
            };
            var addRatioFix = function() {
                return Number(GALLERY_v4_CONSTS.isLayout('SLIDER')(styleParams) ? 0.85 : 1);
            ...
            } else if (!(isInfinite || isFixedHorizontlaGalleryRatio)) {
                return maxByScreen();
            } else {
                return false;
            }
        };
        var getNeededHeight = function(requestedHeight, isResponsive) {
            var newHeight = Math.round(requestedHeight * _this.getViewportScaleRatio(isResponsive));
            var should = false;
            if (isInfinite || isFixedHorizontlaGalleryRatio) {
                should = true;
            }
            if (updatedHeight) {
                should = true;
        ...
        var shouldSetHeight = function() {
            ...
            var shouldSetOnLayoutChangeToHorizontal = !(isInfinite || isFixedHorizontlaGalleryRatio) &&
                !isResponsive &&
                isChangedLayout &&
                allowHeightChangeOnNewLayout;
            var should = isInfinite ||
                isFixedHorizontlaGalleryRatio ||
                updatedHeight ||
                shouldSetOnLayoutChangeToHorizontal;
            if (!should) {
        ...
        if (shouldSetHeight.call(this)) {
            ...
            var finalHeight = getNeededHeight.call(this, height, !!styleParams.responsive);
