...
var NavigationHelper = /** @class */ (function(_super) {
    ...
    function NavigationHelper() {
        ...
        _this.dispatchNavigationInIfNeeded = _this.dispatchNavigationInIfNeeded.bind(_this);
        _this.dispatchNavigationOutIfNeeded = _this.dispatchNavigationOutIfNeeded.bind(_this);
        _this.unsubscribeToOnDisplayChange = _this.unsubscribeToOnDisplayChange.bind(_this);
    ...
    NavigationHelper.prototype.initializeEventListeners = function() {
        ...
        Wix.addEventListener(Wix.Events.PAGE_NAVIGATION_IN, this.handleWixDisplayIn);
        Wix.addEventListener(Wix.Events.PAGE_NAVIGATION_OUT, this.handleWixDisplayOut);
    ...
    NavigationHelper.prototype.subscribeToOnDisplayChange = function(onDisplayChange) {
        if (!this.isInitialized)
            this.initializeEventListeners();
        this.on(ON_DISPLAY_CHANGE, onDisplayChange);
    };
    NavigationHelper.prototype.unsubscribeToOnDisplayChange = function(onDisplayChange) {
