...
var UnchangingImageRenderer = /** @class */ (function(_super) {
    ...
    UnchangingImageRenderer.prototype.UNSAFE_componentWillReceiveProps = function(nextProps) {
        ...
        if (nextProps.allowChanges && nextProps.allowChanges !== this.state.allowChanges) {
            this.setState({
                allowChanges: true,
                current: __assign(__assign({}, this.state.current), this.state.latest),
            });
        }
    };
