...
var CustomButton = /** @class */ (function(_super) {
    ...
    CustomButton.prototype.render = function() {
        ...
        var justifyContent = this.props.isNewInfoElements ? this.props.horizontalAlignment : options.galleryHorizontalAlign;
        if (options.isRTL) {
        ...
        return (React.createElement("div", {
            ...
            style: style
        }, this.props.small && options.isStoreGallery ? (React.createElement(CustomButtonIcon, null)) : (React.createElement("button", {
