...
var Download = /** @class */ (function(_super) {
    ...
    function Download(props) {
        ...
        _this.onDownloadImageVideoKeyPress = _this.onDownloadImageVideoKeyPress.bind(_this);
    ...
    Download.prototype.onDownloadImageVideoKeyPress = function(e, downloadLink) {
        switch (e.keyCode || e.charCode) {
            ...
            case 13: // enter
                ...
                this.props.actions.eventsListener(INFO_EVENTS.DOWNLOAD_BUTTON_CLICKED, this.props);
                return false;
            default:
                break;
        }
    ...
    Download.prototype.onDownloadTextKeyPress = function(e) {
        switch (e.keyCode || e.charCode) {
            ...
            case 13: // enter
                e.stopPropagation();
                e.preventDefault();
                this.props.actions.eventsListener(INFO_EVENTS.TEXT_DOWNLOAD_BUTTON_CLICKED, this.props);
                return false;
            default:
                break;
        }
    ...
    Download.prototype.onDownloadClick = function(e, downloadLink) {
        return __awaiter(this, void 0, void 0, function() {
            var _a, type, isDemo, actions, customDownloadUrl, downloadUrl, _b, url, photoId;
            return __generator(this, function(_c) {
                _a = this.props, type = _a.type, isDemo = _a.isDemo, actions = _a.actions, customDownloadUrl = _a.customDownloadUrl;
                if (type === 'text') {
                    e.stopPropagation();
                    e.preventDefault();
                    actions.eventsListener(INFO_EVENTS.TEXT_DOWNLOAD_BUTTON_CLICKED, this.props);
                } else if (!isDemo) {
                    // not text && not Demo
                    e.stopPropagation();
                    e.preventDefault();
    ...
    Download.prototype.render = function() {
        ...
        var downloadClassName = 'info-member info-element-social-download ' +
            (options.allowSocial ? '' : ' pull-right ') +
            ' info-element-social-button';
        var downloadIcon = (React.createElement("i", {
        ...
        var downloadLink = createUrl(downloadUrl, GALLERY_v4_CONSTS.urlTypes.VIDEO) ||
        ...
        return (React.createElement("div", __assign({
            ...
            "aria-label": "Download",
            role: "button",
            tabIndex: GALLERY_v4_CONSTS.isLayout('SLIDESHOW')(options) &&
        ...
        }, this.getAdditionalAttributes(downloadLink)), downloadIcon));
    };
    return Download;
}(React.Component));
