...
var LoveButton = /** @class */ (function(_super) {
    ...
    LoveButton.prototype.toggleLove = function(e) {
        e.stopPropagation();
        e.preventDefault();
        this.props.actions.eventsListener(INFO_EVENTS.LOVE_BUTTON_CLICKED, this.props);
        this.setState({
    ...
    LoveButton.prototype.createLoveCounter = function() {
        ...
        return !!this.props.showCounter && count > 0 ? (React.createElement("i", {
    ...
    LoveButton.prototype.render = function() {
        ...
        var clickAction = this.props.viewMode === GALLERY_v4_CONSTS.viewMode.SITE ||
        ...
        return (React.createElement("span", __assign({
                className: 'info-member info-element-social-love info-element-social-button',
                "data-hook": "love-button"
            }, clickAction, {
                onKeyDown: this.onKeyPress,
                tabIndex: GALLERY_v4_CONSTS.isLayout('SLIDESHOW')(this.props.options) &&
            ...
            React.createElement("button", {
                ...
                style: loveColor,
                tabIndex: -1
            }, this.props.isLoved ? (React.createElement(LoveFull, null)) : (React.createElement(LoveEmpty, null))),
            loveCounter));
    };
    return LoveButton;
}(React.Component));
