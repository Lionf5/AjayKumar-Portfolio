...
var MasterInfoElement = function(props) {
    ...
    var master = createMasterInfo(masterInfoConfig, CompsMap, shouldControlHorizontalAlignment);
    var style = {
...
var Section = function(props) {
    ...
    return (React.createElement("div", {
            className: "section ".concat(props.position),
            style: innerStyle
        },
...
var Aligner = function(props) {
    ...
    return (React.createElement("div", {
        className: horizontalAlignmentClass,
        style: style
    }, props.children));
};
...
function SingleInfo(props) {
    ...
    return (React.createElement(Aligner, {
            horizontalAlignment: infoParams.horizontalAlignment
        },
        React.createElement(InfoClass, __assign({}, infoParams, {
...
function createSection(orderList, masterInfoConfig, CompsMap, shouldControlHorizontalAlignment) {
...
function createRealSection(sName, masterInfoConfig, CompsMap, shouldControlHorizontalAlignment) {
    var orderList = masterInfoConfig.order[sName];
    var rendererComps = createSection(orderList, masterInfoConfig, CompsMap, shouldControlHorizontalAlignment);
    var style = {};
...
function createMasterInfo(masterInfoConfig, CompsMap, shouldControlHorizontalAlignment) {
    /* const masterInfoConfig = config[masterInfoName] */
    var top = 'top';
    var middle = 'middle';
    var bottom = 'bottom';
    var sections = [top, middle, bottom].map(function(x) {
        return createRealSection(x, masterInfoConfig, CompsMap, shouldControlHorizontalAlignment);
    });
    var gridStyle = {
        display: 'grid',
        height: '100%',
