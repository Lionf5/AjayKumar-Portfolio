...
import {
    getFinalStyle
} from '../sharedBetweenInfoComponents';
var Social = /** @class */ (function(_super) {
    ...
    Social.prototype.getSocialShare = function() {
        ...
        if (options.allowSocial) {
            var shareButton = (React.createElement("i", {
                    className: 'share-store'
                },
                React.createElement(ShareStoreIcon, null)));
            var socialShareClassName = 'info-member info-element-social-share info-element-social-button';
            if (this.props.viewMode === GALLERY_v4_CONSTS.viewMode.SITE ||
                this.props.viewMode === GALLERY_v4_CONSTS.viewMode.SEO) {
                var slideshowShare = !this.props.shouldUseNewSocialSharePopup &&
    ...
    Social.prototype.getLoveButton = function() {
        ...
        return options.loveButton ? (React.createElement(LoveButton, __assign({}, this.props, {
    ...
    Social.prototype.render = function() {
        ...
        var isPopulated = options.allowSocial || options.loveButton || options.allowDownload;
        var textPlacementAboveOrBelowOrRightOrLeft = this.props.internalOrExternal === 'external' ||
        ...
        return (React.createElement("div", {
                style: finalStyle,
                className: 'info-element-social info-align-' +
