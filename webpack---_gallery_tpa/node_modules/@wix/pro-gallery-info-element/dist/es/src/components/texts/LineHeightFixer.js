...
var LineHeightFixer = /** @class */ (function() {
    ...
    LineHeightFixer.prototype.shouldFix = function(oldProps, newProps) {
        ...
        var newIsSocialPopulated = newOptions.allowSocial ||
        ...
        return (style.height !== newStyle.height ||
    ...
    LineHeightFixer.prototype.calcAvailableHeight = function(props, textsContainerAvailableHeight) {
    ...
    LineHeightFixer.prototype.fix = function(props, textsContainer) {
        ...
        for (var _i = 0, _a = options.titlePlacement.split(','); _i < _a.length; _i++) {
            var placement = _a[_i];
            var textPlacementRightOrLeft = GALLERY_v4_CONSTS.hasExternalHorizontalPlacement(placement);
            var textPlacementAboveOrBelow = GALLERY_v4_CONSTS.hasExternalVerticalPlacement(placement);
            ...
            if (props.isNewInfoElements) {
                ...
                if (social) {
                    ...
                    var socialHeight = sizeOf(socialStyle, 'height') +
            ...
            if (Object.values(availableDimensions).some(function(val) {
                    return val <= 0;
                })) {
            ...
            if (shouldDisplayTitle) {
                ...
                if (titleElements.length === 1) {
                    var titleHeight = // when padding is large and the we decrease padding the clientHeight stay small
                        ...
                        parseInt(titleElement.children[0].offsetHeight) :
                        parseInt(titleElement.clientHeight);
                    var titleFontSize = parseInt(this.getCss(titleElement, 'font-size', 16));
                    var titleLineHeight = this.getLineHeightInPixels(this.getCss(titleElement, 'line-height', 'normal'), titleFontSize);
            ...
            var shouldDisplayDescription = descriptionElement &&
                description &&
            ...
            if (shouldDisplayDescription) {
                ...
                var descriptionFontSize = parseInt(this.getCss(descriptionElement, 'font-size', 16));
                var lineHeight = this.getLineHeightInPixels(this.getCss(descriptionElement, 'line-height', 'normal'), descriptionFontSize);
    ...
    LineHeightFixer.prototype.getLineHeightInPixels = function(lineHeightValue, fontSize) {
