...
var Texts = /** @class */ (function(_super) {
    ...
    Texts.prototype.getTextsStyles = function() {
        ...
        if (GALLERY_v4_CONSTS.hasExternalVerticalPlacement(options.titlePlacement)) {
            textsStyles = __assign(__assign({}, textsStyles), getDuplicatedCss(options));
        }
        // Horizontal placement is not yet implemented in wix editor, but the gallery support it (for example in the designed presets)
        if (GALLERY_v4_CONSTS.hasExternalHorizontalPlacement(options.titlePlacement)) {
            textsStyles = __assign(__assign(__assign({}, textsStyles), getDuplicatedCss(options)), {
                display: 'flex',
    ...
    Texts.prototype.getItemTexts = function() {
        ...
        var titleElem = shouldShowTitle && (React.createElement(Title, {
            key: 'item-title-' + id,
            title: title,
            style: titleStyle
        }));
        var descriptionElem = shouldShowDescription && (React.createElement(Description, {
            key: 'item-description-' + id,
            description: description,
            style: descStyle
        }));
        var buttonElem = shouldShowButton && (React.createElement(CustomButton, {
            type: "button",
            options: options,
            style: style,
            small: isNarrow,
        ...
        var allTextsElements = (React.createElement(React.Fragment, null,
            titleElem,
            descriptionElem,
            buttonElem));
        return (React.createElement("div", {
                ...
                dir: "auto"
            }, GALLERY_v4_CONSTS.isLayout('SLIDESHOW')(options) ? (allTextsElements) : (React.createElement("div", null, allTextsElements)) // wrapped with div for flex alignment purposes
        ));
    };
