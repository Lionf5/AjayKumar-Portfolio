...
function getComponentCssVariables(styles, customExpressions, cssVars, customOptions, defaults, customCssVars) {
    var cssVariables = {};
    var options = __assign(__assign({}, common_1.defaultOptions), (customOptions || {}));
    var tpaParams = (0, generateTPAParams_1.generateTPAParams)(styles.siteColors, styles.siteTextPresets, styles.styleParams, options, defaults);
    // globals
    ...
    Object.entries(tpaParams.numbers).forEach(function(_a) {
        var key = _a[0],
            value = _a[1];
        var cssVariable = emitCssVariable(key, cssFunctions_1.cssFunctions.number(value));
    ...
    Object.entries(tpaParams.colors)
        ...
        .forEach(function(_a) {
            var key = _a[0],
                color = _a[1];
            try {
                var rgbParts = (0, cssFunctions_1.toRgbParts)(cssFunctions_1.cssFunctions.color(color, tpaParams));
    ...
    Object.entries(tpaParams.fonts)
        ...
        .forEach(function(_a) {
            var key = _a[0],
                font = _a[1];
            try {
                var cssVariable = emitCssVariable(key, cssFunctions_1.cssFunctions.font(font, tpaParams));
                cssVariables[cssVariable.key] = cssVariable.value;
                ...
                cssVariables["".concat(cssVariable.key, "-size")] = (0, utils_1.withDefaultPxUnit)(font.size);
                cssVariables["".concat(cssVariable.key, "-line-height")] = (0, utils_1.withDefaultPxUnit)(font.lineHeight);
                cssVariables["".concat(cssVariable.key, "-family")] = wixStyleFontUtils_1.wixStylesFontUtils.stringifyFontFamily(font.family);
...
function getSiteCssVariables(siteColors, siteTextPresets) {
    ...
    var tpaParams = (0, generateTPAParams_1.generateTPAParams)(siteColors, siteTextPresets, emptyStyleParams, common_1.defaultOptions, {});
    // colors
    Object.entries(tpaParams.colors)
        .filter(function(_a) {
            var key = _a[0];
    ...
    Object.entries(tpaParams.fonts)
        ...
        .forEach(function(_a) {
            var key = _a[0],
                font = _a[1];
            var cssVariable = emitCssVariable(key, cssFunctions_1.cssFunctions.font(font, tpaParams), prefixes.textPresets);
            cssVariables[cssVariable.key] = cssVariable.value;
            cssVariables["".concat(cssVariable.key, "-style")] = font.style;
            cssVariables["".concat(cssVariable.key, "-variant")] = font.variant;
            cssVariables["".concat(cssVariable.key, "-weight")] = font.weight;
