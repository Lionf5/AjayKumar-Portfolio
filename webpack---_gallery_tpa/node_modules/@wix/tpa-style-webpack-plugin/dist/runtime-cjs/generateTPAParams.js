...
function generateTPAParamsFromStyleParams(styleParams, siteColors, siteTextPresets, options) {
    var _a;
    if (options === void 0) {
        options = {};
    }
    var colorStyles = styleParams.colors;
    var fontStyles = (0, utils_1.pickBy)(styleParams.fonts, wixStyleFontUtils_1.wixStylesFontUtils.isValidFontParam);
    var numbers = styleParams.numbers || {};
    var colors = wixStylesColorUtils_1.wixStylesColorUtils.getFullColorStyles({
        colorStyles: colorStyles,
        siteColors: siteColors
    }) || {};
    var fonts = wixStyleFontUtils_1.wixStylesFontUtils.getFullFontStyles({
        fontStyles: fontStyles,
        siteTextPresets: siteTextPresets
    }) || {};
    var strings = (0, utils_1.pickBy)(styleParams.fonts, wixStyleFontUtils_1.wixStylesFontUtils.isStringHack);
    var booleans = __assign(__assign({}, styleParams.booleans), (_a = {}, _a[constants_1.IS_RTL_PARAM] = options.isRTL, _a));
    return {
        colors: colors,
        fonts: fonts,
        numbers: numbers,
...
function generateTPAParams(siteColors, siteTextPresets, styleParams, options, defaults) {
    var styleParamsWithDefaults = overrideStyleParamsWithDefaults({
        styleParams: styleParams,
        siteColors: siteColors,
        siteTextPresets: siteTextPresets,
    }, defaults, options);
    return generateTPAParamsFromStyleParams(styleParamsWithDefaults, siteColors, siteTextPresets, options);
}
