...
exports.generateTPAParamsFromStyleParams = exports.getComponentCssVariables = exports.getSiteCssVariables = exports.getBuildTimeStaticCss = exports.getStaticCssWithConfig = exports.getProcessedCssWithConfig = exports.getProcessedCssWithVars = void 0;
...
function getProcessedCssWithVars(dynamicExpressions, cssVars, _a, options, defaults) {
    ...
    var tpaParams = (0, generateTPAParams_1.generateTPAParams)(siteColors, siteTextPresets, styleParams, options, defaults);
...
function getProcessedCssWithConfig(processedCssConfig, _a, options) {
    ...
    var prefixedCss = processedCssConfig.css.replace(new RegExp(processedCssConfig.compilationHash, 'g'), options.prefixSelector ? "".concat(options.prefixSelector) : '');
    var tpaParams = (0, generateTPAParams_1.generateTPAParams)(siteColors, siteTextPresets, styleParams, options, processedCssConfig.defaults);
    var processor = (0, processor_1.getProcessor)({
...
function getBuildTimeStaticCss(staticCssConfig) {
    ...
    return {
        css: prefixedCss,
        hash: staticCssConfig.staticCssHash
    };
}
