...
export var cssFunctions = {
    ...
    fontWithSize: function(font, size, tpaParams) {
        var fontValueFromObject = wixStylesFontUtils.parseFontFromObject(font, tpaParams);
        var fontValue = fontValueFromObject ?
            __assign(__assign({}, fontValueFromObject), {
                size: size
            }) : typeof font === 'string' && font.indexOf('font:') === 0 ?
            __assign(__assign({}, wixStylesFontUtils.parseFontFromString(font.slice(5, font.length - 1))), {
                size: size
            }) : undefined;
        if (!fontValue) {
            return escapeHtml(font);
    ...
    fontSize: function(font, tpaParams) {
        try {
            var fontValue = wixStylesFontUtils.parseFontFromObject(font, tpaParams) ||
                wixStylesFontUtils.parseFontFromString(font) || {
                    size: ''
                };
