...
import {
    wixStylesColorUtils
} from './utils/wixStylesColorUtils';
import {
    IS_RTL_PARAM
} from './constants';
...
export function generateTPAParamsFromStyleParams(styleParams, siteColors, siteTextPresets, options) {
    var _a;
    if (options === void 0) {
        options = {};
    }
    ...
    var colors = wixStylesColorUtils.getFullColorStyles({
        colorStyles: colorStyles,
        siteColors: siteColors
    }) || {};
    var fonts = wixStylesFontUtils.getFullFontStyles({
...
export function generateTPAParams(siteColors, siteTextPresets, styleParams, options, defaults) {
