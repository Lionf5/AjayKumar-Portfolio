...
export function getProcessedCssWithVars(dynamicExpressions, cssVars, _a, options, defaults) {
    var siteColors = _a.siteColors,
        siteTextPresets = _a.siteTextPresets,
        styleParams = _a.styleParams;
    options = __assign(__assign({}, defaultOptions), (options || {}));
    var tpaParams = generateTPAParams(siteColors, siteTextPresets, styleParams, options, defaults);
...
export function getProcessedCssWithConfig(processedCssConfig, _a, options) {
    ...
    var tpaParams = generateTPAParams(siteColors, siteTextPresets, styleParams, options, processedCssConfig.defaults);
    var processor = getProcessor({
...
from './css-variables';
export {
    generateTPAParamsFromStyleParams
}
from './generateTPAParams';
