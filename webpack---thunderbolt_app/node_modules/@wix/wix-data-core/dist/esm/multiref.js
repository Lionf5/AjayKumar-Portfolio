...
var WixDataQueryReferencedResult = /** @class */ (function() {
    ...
    WixDataQueryReferencedResult.prototype._getNewCursorQuery = function(cursor) {
        return referenceResultFactory({}, this._provider, this._collectionName, this._holdingItemId, // Needed for cloud-data as for validations at the beginning of the pipeline. TODO: fix validations
            this._referenceAttribute, // Needed for cloud-data as for validations at the beginning of the pipeline. TODO: fix validations
            {
                cursor: cursor,
                limit: this._limit,
            });
