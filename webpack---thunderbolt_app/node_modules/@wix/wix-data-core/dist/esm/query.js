...
var WixDataQuery = /** @class */ (function(_super) {
    ...
    WixDataQuery.prototype.count = function(options) {
        ...
        return rejectIfInvalid(this.invalidArguments, this.collectionName)
            ...
            .then(function() {
                return _this.provider.count(_this.collectionName, _this.filterTree, options);
            })
    ...
    WixDataQuery.prototype.distinct = function(fieldName, options) {
        ...
        return rejectIfInvalid(this.invalidArguments, this.collectionName)
            ...
            .then(function() {
                return apiValidator().fieldName(fieldName).validateAndReject();
            })
            .then(function() {
                return _this.provider.distinct(_this.collectionName, _this.filterTree, _this.orderBy, fieldName, _this.skipNumber, _this.limitNumber, options, _this.cursor, undefined, omitTotalCount);
            })
            .then(function(result) {
                var _a = result.pagingMetadata,
                    _b = _a === void 0 ? new PagingMetadata() : _a,
                    cursors = _b.cursors,
                    _c = _b.hasNext,
                    hasNext = _c === void 0 ? false : _c;
                return new WixDataQueryResult({
                    ...
                    pagingFunction: function() {
                        return this.distinct(fieldName, options);
                    },
                    hasNext: hasNext,
                });
            });
    ...
    WixDataQuery.prototype.find = function(options) {
        ...
        return rejectIfInvalid(this.invalidArguments, this.collectionName)
            ...
            .then(function() {
                ...
                return _this.provider.find(_this.collectionName, _this.filterTree, _this.orderBy, skipNumber, _this.limitNumber, options, _this.included, omitTotalCount, _this.cursor, _this.projectedFields);
            })
            .then(function(result) {
                return new WixDataQueryResult({
                    createdByCursor: _this.cursor,
                    ...
                    query: self,
                    items: result.items,
                    cursors: result.pagingMetadata.cursors,
    ...
    WixDataQuery.prototype._withSkipNumber = function(query, length, isNext) {
        this.skipNumber = calcSkipNumber(query, length, isNext);
        return this;
    };
    return WixDataQuery;
