...
export var handleJsonErrorResponse = function(trace) {
    return function(error) {
        ...
        return trace('wix-data-error-response', {
            ...
            .then(function() {
                var _a, _b;
                // Logging full request to help debug an nginx issue
                if (((_a = error === null || error === void 0 ? void 0 : error.response) === null || _a === void 0 ? void 0 : _a.status) === 400) {
                    trace('wix-data-error-response-status-400-debug', {
                        errorRequest: error === null || error === void 0 ? void 0 : error.request,
                    })(function() {});
                }
                if (isPayloadTooLarge(error)) {
                    return payloadTooLargeError();
                }
                var jsonError = (_b = error === null || error === void 0 ? void 0 : error.response) === null || _b === void 0 ? void 0 : _b.data;
...
export var parseApplicationError = function(error) {
    ...
    return wixDataError(error.details.applicationError.description, code);
};

function parseValidationError(error) {
    var validationMessages = (error.details.validationError.fieldViolations || [])
        .map(function(v) {
    ...
    return wixDataError(message, ValidationErrorCode);
}
