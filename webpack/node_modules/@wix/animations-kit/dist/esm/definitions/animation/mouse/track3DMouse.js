...
export function animate(_kit, elements, _duration, _delay, {
    ...
    return {
        progress(progressX, progressY) {
            ...
            element.style.transform = `perspective(${perspective}px) translateX(${translateX}${units}) translateY(${translateY}${units}) rotateX(${rotateX}deg) rotateY(${rotateY}deg) rotate(${currentRotation}deg)`;
        },
        kill() {
